...
import com.example.bluetooth.Constants.Device;
import com.example.bluetooth.UIElements.ThreadHandler;
import com.example.bluetooth.utils.CodeSnippet;
...
public class CameraModelImplementation implements CameraModel, BluetoothListener, Camera.PreviewCallback {
    ...
    public CameraModelImplementation(CameraModelListener cameraModelListener) {
    ...
    public static CameraModel newInstance(CameraModelListener cameraModelListener) {
        return new CameraModelImplementation(cameraModelListener);
    }
    ...
    @Override
    public CameraModelImplementation getPreviewCallback() {
        return this;
    }
