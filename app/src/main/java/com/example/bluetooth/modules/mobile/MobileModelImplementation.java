...
public class MobileModelImplementation implements MobileModel {
    ...
    public MobileModelImplementation(MobileModelListener mobileModelListener) {
    ...
    public static MobileModel newInstance(MobileModelListener mobileModelListener) {
        return new MobileModelImplementation(mobileModelListener);
    }
